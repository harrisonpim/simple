...
cutting the words you can use to only the ten-hundred most-used words in your language really makes you think about an idea and your explanation of it. this page does that cutting for you.
...
the page is written with [act-because-of.js](https://reactjs.org/) and mostly [special-piece-which-goes-faster-than-light-and-makes-time-go-strange CSS](https://tachyons.io/).
